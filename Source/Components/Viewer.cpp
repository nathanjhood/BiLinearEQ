...
Viewer::Viewer (juce::AudioProcessorValueTreeState& apvts) :
    state (apvts),
    forwardFFT (order)
{
    ...
    eqShapeParameter    = state.getRawParameterValue ("shape");
    eqFreqParameter     = state.getRawParameterValue ("frequencyID");
    eqQParameter        = state.getRawParameterValue ("resonanceID");
    eqGainParameter     = state.getRawParameterValue ("gainID");
